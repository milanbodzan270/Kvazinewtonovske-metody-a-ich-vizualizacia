...
def quasiNewton_method(f_num, f_sym, x0, tol, method):
    ...
    while np.linalg.norm(g) > tol:
        ...
        #Spočítanie korekčnej matice vzhľadom na výber metódy:
...
#Volanie konkrétnych funkcií:    
convergence_map_full(f1_num, f1_sym, 1e-6, "SR1", x1_range = (-3, 7), x2_range = (-6, 4), title=r"$f_1$")      
